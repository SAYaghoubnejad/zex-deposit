...
COPY abstracts.py /app/zbtc/abstracts.py
COPY config.py /app/zbtc/config.py
COPY node.py /app/zbtc/node.py
COPY zbtc_uilts.py /app/zbtc/zbtc_utils.py

# Command to run the application
CMD ["python3", "zbtc/node.py"]
